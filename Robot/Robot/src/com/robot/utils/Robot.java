...
import com.robot.utils.database.DBReader;
import com.robot.utils.database.DBWriter;
import com.robot.utils.database.Field;
import com.robot.utils.database.Tuple;
...
/**
 * Classe rappresentante la macchina a stati finiti con memoria su database.
 *
...
public class Robot {
     ...
     *
     * @see com.robot.utils.database
     */
    private DBConnector databaseConnector;
    /**
     * Lettore del database
     *
     * @see com.robot.utils.database
     */
    private DBReader databaseReader;
    /**
     * Scrittore del database
     *
     * @see com.robot.utils.database
     */
    ...
    /**
     * Posto dove vive l'utente.
     */

    public String placeOfLiving;
    /**
     * Stato dove vive l'utente.
     */
    ...
    private int age;
    /**
     * Indica se il robot è terminato.
     */
    public boolean ended;
    /**
     * Indica se l'utente ha già fatto una sessione.
     */
    ...
    private long id;
    /**
     * Il contatore interno per le domande dei sotto arogmenti.
     */
    private int topicCounter;
    /**
     * Una tupla del Database
     */
    private Tuple topicRow;
    /**
     * Il nome della tabella del database.
     */
    ...
    /**
     * Seleziona un argomento a caso.
     *
     * @return arogmento scelto
     */
    ...
    /**
     * Termina la macchina a stati finiti.
     */
    ...
    /**
     * Registra il nuovo utente sul database.
     *
     * @param id il token
     * @param ip l'ip corrente dell'utente
     * @param port la porta corrente dell'utente
     */
    ...
    /**
     * Inserisce i campi nella tupla che andrà scritta nel database.
     *
    ...
    /**
     * Crea il robot in base a quello preregistrato nel databse dall'utente.
     *
     * @param id token
     */
    ...
    /**
     * Scrive nel database i valori "personali" dell'utente.
     *
     * @param DBName il nome della tabella
     * @return se scritto con successo.
     */
    ...
    /**
     * Scrive dei campi di una tabella nel database
     *
     * @param dBName nome tabella
     * @param fields lista di campi caratterizzati da nome,valore
     * @param whereCondition dove scrivere
     */
    ...
    /**
     * Scrive un unico campo nel database
     *
     * @param dBName nome tabella
     * @param field cmapo caratterizzato da nome,valore
     * @param whereCondition dove scrivere
     */
    ...
    /**
     * Legge un campo dal database
     *
     * @param dbName tabella dela database
     * @param whereCondition condizione
    ...
    /**
     * Memorizzazione stato "COOKING"
     *
     * @param input la stringa letta
     * @return se finito
     */
    ...
    /**
     * Legge una tupla dove precedentemente l'utente abbia gradito.
     */
    ...
    /**
     * Proponi domande di "COOKING"
     *
     * @param t tupla dove registrare
     * @return messaggio
     */
