...
public class DialogueManager{
    ...
    public DialogueManager() {
        ...
        glossaries[0] = new Glossary("Robot/Glossary/glossary_greeting.xml");
        glossaries[1] = new Glossary("Robot/Glossary/glossary_whats_your_name.xml");
        glossaries[2] = new Glossary("Robot/Glossary/glossary_do_you_think.xml");
        glossaries[3] = new Glossary("Robot/Glossary/glossary_what_are_you_thinking.xml");
        glossaries[4] = new Glossary("Robot/Glossary/glossary_your_activities.xml");
        glossaries[5] = new Glossary("Robot/Glossary/glossary_how_are_you.xml");
        glossaries[6] = new Glossary("Robot/Glossary/glossary_sing_for_me.xml");
        glossaries[7] = new Glossary("Robot/Glossary/glossary_tell_me_a_story.xml");
        glossaries[20] = new Glossary("Robot/Glossary/glossary_what_time.xml");
        glossaries[21] = new Glossary("Robot/Glossary/glossary_what_date.xml");
        glossaries[22] = new Glossary("Robot/Glossary/glossary_weather.xml");
        glossaries[23] = new Glossary("Robot/Glossary/glossary_search_that.xml");
        glossaries[40] = new Glossary("Robot/Glossary/glossary_message_n.xml");
        glossaries[41] = new Glossary("Robot/Glossary/glossary_my_message_n.xml");
        glossaries[42] = new Glossary("Robot/Glossary/glossary_your_message_n.xml");
        glossaries[43] = new Glossary("Robot/Glossary/glossary_my_question_n.xml");
        glossaries[44] = new Glossary("Robot/Glossary/glossary_your_question_n.xml");
        glossaries[60] = new Glossary("Robot/Glossary/glossary_whats_my_name.xml");
        glossaries[61] = new Glossary("Robot/Glossary/glossary_whats_my_nickname.xml");
        glossaries[62] = new Glossary("Robot/Glossary/glossary_whats_my_gender.xml");
        glossaries[63] = new Glossary("Robot/Glossary/glossary_how_old_am_i.xml");
        glossaries[64] = new Glossary("Robot/Glossary/glossary_how_am_i_feeling.xml");
        glossaries[65] = new Glossary("Robot/Glossary/glossary_whats_my_job.xml");
        glossaries[66] = new Glossary("Robot/Glossary/glossary_whats_my_hobby.xml");
        glossaries[67] = new Glossary("Robot/Glossary/glossary_all_about_me.xml");
        glossaries[80] = new Glossary("Robot/Glossary/glossary_my_name_is.xml");
        glossaries[81] = new Glossary("Robot/Glossary/glossary_my_nickname_is.xml");
        glossaries[82] = new Glossary("Robot/Glossary/glossary_my_age_is.xml");
        glossaries[83] = new Glossary("Robot/Glossary/glossary_my_gender_is.xml");
        glossaries[84] = new Glossary("Robot/Glossary/glossary_i_am_feeling.xml");
        glossaries[85] = new Glossary("Robot/Glossary/glossary_my_job_is.xml");
        glossaries[86] = new Glossary("Robot/Glossary/glossary_my_hobby_is.xml");
        glossaries[104] = new Glossary("Robot/Glossary/glossary_bad_words.xml");
        routes = new DialogueRoute[200];
        routes[0] = new DialogueRoute("Robot/Routes/route_greet.xml", 0);
        routes[1] = new DialogueRoute("Robot/Routes/route_my_name_is.xml", 0);
        routes[2] = new DialogueRoute("Robot/Routes/route_are_you_intelligent.xml", 2);
        routes[3] = new DialogueRoute("Robot/Routes/route_i_am_thinking_about.xml", 0);
        routes[4] = new DialogueRoute("Robot/Routes/route_activities.xml", 2);
        routes[5] = new DialogueRoute("Robot/Routes/route_how_do_you_feel.xml", 0);
        routes[6] = new DialogueRoute("Robot/Routes/route_sing.xml", 0);
        routes[7] = new DialogueRoute("Robot/Routes/route_stories.xml", 0);
        routes[100] = new DialogueRoute("Robot/Routes/route_repeat.xml", 0);
        routes[101] = new DialogueRoute("Robot/Routes/route_nothing_said.xml", 0);
        routes[102] = new DialogueRoute("Robot/Routes/route_cant_understand.xml", 0);
        routes[103] = new DialogueRoute("Robot/Routes/route_unknown_language.xml", 1);
        routes[104] = new DialogueRoute("Robot/Routes/route_bad_words.xml", 0);
    ...
    private String getInfoFromMessage(String message, int id){
        ...
        String info = "";
        if(message.indexOf(notInfo)==0){
            info = message.substring(notInfo.length()+1);
        } else{
            info = message.substring(0, message.indexOf(notInfo));
        }
        return info;
    }
