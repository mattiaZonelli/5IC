...
public class Client {
	...
	public static void main(String[] args) throws IOException {
		Client c = new Client();//Nel costruttore instauro la connessione con il server, inizializzo il canale socket e i vari reader 
		c.send();//Qui mando il messaggio che voglio per aspettare la risposta del server
	}
}
