...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String[] FIELDS = {
            "_id INTEGER PRIMARY KEY,", "QUESTION TEXT,", "ANSWER_1 TEXT,", "ANSWER_2 TEXT,", "ANSWER_3 TEXT,", "ANSWER_4 TEXT,", "CORRECT_ANSWER INTEGER"
    };
    ...
    public void insert(FeedReaderDbHelper mDbHelper, String[] values) {
        ...
        for (int i = 0; i < NAME_FIELDS.length; i++) {
            contentValues.put(NAME_FIELDS[i], values[i]);
        }
